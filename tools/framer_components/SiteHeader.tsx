 ...
 * action.
 *
 * Sticky is off by default so the header sits in normal flow and has real
 * height on the canvas. Pin it using Framer's own position controls rather
 * than turning Sticky on.
 *
    ...
    return (
        <div
            ...
            style={{
                ...style,
                position: "relative",
                // a fixed header is out of flow, so reserve its height or the
                // component collapses to nothing on the canvas
                minHeight: sticky ? "var(--header-h)" : undefined,
            }}
        >
...
addPropertyControls(SiteHeader, {
    ...
    sticky: {
        type: ControlType.Boolean, title: "Sticky", defaultValue: false,
        description: "Off keeps the header in normal flow, which is what you want on a Framer canvas — pin it in Framer instead. On uses CSS position: fixed.",
    },
